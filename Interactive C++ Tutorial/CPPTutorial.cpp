/*
    ...
    - 2022
    - C++20
    A general interactive programming tutorial tool, used primarily to learn C/C++
*/
...
void HomeTut() {
    std::cout << "Welcome to an interactive C++ and general programming tutorial!\n This tutorial aims to teach the basic concepts of programming and C++ in a simple, quick manner with interactive steps.";
    std::cout << "Press enter to continue, or, skip to a chapter:\n\t";
